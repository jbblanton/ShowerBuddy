...
// Total shower time plus 2 minutes for drying; will return screen to dashboard:
const exitShowerFlow = (duration) => {
  const exitTime = (duration + 120) * 60000
  console.log('EXIT BUTTON')
  console.log(exitTime)
  setTimeout(() => {$("div.shower-action").hide()}, exitTime);
